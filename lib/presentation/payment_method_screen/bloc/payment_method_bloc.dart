...
import 'package:micasa_home_gh/presentation/payment_method_screen/models/payment_method_model.dart';
...
class PaymentMethodBloc extends Bloc<PaymentMethodEvent, PaymentMethodState> {
  ...
  _changeCheckBox(
    ...
    emit(state.copyWith(vector: event.value));
  }
  ...
  _changeCheckBox1(
    ...
    emit(state.copyWith(checkboxoff: event.value));
  }
  ...
  _onInitialize(
    ...
    emit(state.copyWith(vector: false, checkboxoff: false));
  }
}
