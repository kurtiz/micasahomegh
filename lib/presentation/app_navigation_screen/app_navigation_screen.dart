                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            _buildScreenTitle(
                              context,
                              screenTitle: "Boarding".tr,
                              onTapScreenTitle: () =>
                                  onTapScreenTitle(AppRoutes.boardingScreen),
                            ),
                            _buildScreenTitle(
                              context,
                            ...
                            _buildScreenTitle(
                              context,
                              screenTitle: "check out".tr,
                              onTapScreenTitle: () =>
                                  onTapScreenTitle(AppRoutes.checkOutScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              screenTitle: "Congrats".tr,
                              onTapScreenTitle: () =>
                                  onTapScreenTitle(AppRoutes.congratsScreen),
                            ),
                            _buildScreenTitle(
                              context,
                            ...
                            _buildScreenTitle(
                              context,
                              screenTitle: "shipping address".tr,
                              onTapScreenTitle: () => onTapScreenTitle(
                            ...
                            _buildScreenTitle(
                              context,
                              screenTitle: "My reviews".tr,
                              onTapScreenTitle: () =>
                                  onTapScreenTitle(AppRoutes.myReviewsScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              screenTitle: "ADD SHIPPING ADDRESS".tr,
                              onTapScreenTitle: () => onTapScreenTitle(
                                  AppRoutes.addShippingAddressScreen),
                            ),
                            _buildScreenTitle(
                              context,
